...
public class IslandBlueprint {
    ...
    public IslandBlueprint(World world, Coordinate3D lootPosition, ArrayList<Map.Entry<Coordinate3D, Material>> blockMap, ArrayList<Map.Entry<Coordinate3D, TreeType>> treeMap, ArrayList<Coordinate3D> cactusList, ArrayList<String> names, Coordinate3D nameLocation) {
        this.world = world;
