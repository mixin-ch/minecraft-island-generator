...
public class LootManager {
    ...
    static {
        ...
        lootEntries.add(new LootEntry(Material.WHEAT_SEEDS, 0.2, 3));
        lootEntries.add(new LootEntry(Material.BEETROOT_SEEDS, 0.2, 3));
        lootEntries.add(new LootEntry(Material.POTATO, 0.2, 3));
        lootEntries.add(new LootEntry(Material.CARROT, 0.2, 3));
        lootEntries.add(new LootEntry(Material.PUMPKIN_SEEDS, 0.2, 1));
        lootEntries.add(new LootEntry(Material.MELON_SEEDS, 0.2, 1));
        lootEntries.add(new LootEntry(Material.COCOA_BEANS, 0.2, 3));
        lootEntries.add(new LootEntry(Material.BAMBOO, 0.2, 3));
        lootEntries.add(new LootEntry(Material.SUGAR_CANE, 0.2, 3));
        ...
        lootEntries.add(new LootEntry(Material.DARK_OAK_SAPLING, 0.2, 2));
        lootEntries.add(new LootEntry(Material.JUNGLE_SAPLING, 0.2, 2));
        lootEntries.add(new LootEntry(Material.OAK_SAPLING, 0.2, 2));
        lootEntries.add(new LootEntry(Material.SPRUCE_SAPLING, 0.2, 2));
